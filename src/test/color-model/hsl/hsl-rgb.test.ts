...
describe('convertRGBToHSL', () => {
  test('converts black RGB to HSL', () => {
    expect(convertRGBToHSL([0, 0, 0, 1], [0, 0, 0, 1])).toStrictEqual([0, 0, 0, 1]);
  });

  test('converts RGB to HSL', () => {
    expect(convertRGBToHSL([0.12, 0.34, 0.56, 1], [0, 0, 0, 1])).toStrictEqual([
...
describe('convertHSLToRGB', () => {
  test('converts HSL to RGB', () => {
    ...
    expect(convertHSLToRGB(hsl, [0, 0, 0, 1])).toStrictEqual([0.12, 0.33999999999999986, 0.56, 1]);
  });
});
