...
describe('convertRGBToCMYK', () => {
  test('converts black RGB to CMYK', () => {
    expect(convertRGBToCMYK([0, 0, 0, 1], [0, 0, 0, 0, 0])).toStrictEqual([0, 0, 0, 1, 1]);
  });

  test('converts RGB to CMYK', () => {
    expect(convertRGBToCMYK([0.2, 0.34, 0.56, 1], [0, 0, 0, 0, 0])).toStrictEqual([
...
describe('convertCMYKToRGB', () => {
  test('converts CMYK to RGB', () => {
    ...
    expect(convertCMYKToRGB(cmyk, [0, 0, 0, 1])).toStrictEqual([0.19999999999999996, 0.3400000000000001, 0.56, 1]);
  });
});
