...
describe('convertRGBToLAB', () => {
  test('converts black RGB to LAB', () => {
    expect(convertRGBToLAB([0, 0, 0, 1], [0, 0, 0, 1])).toStrictEqual([0, 0.5, 0.5, 1]);
  });

  test('converts white RGB to LAB', () => {
    expect(convertRGBToLAB([1, 1, 1, 1], [0, 0, 0, 1])).toStrictEqual([
...
describe('convertLABToRGB', () => {
  test('converts LAB to RGB', () => {
    ...
    expect(convertLABToRGB(lab, [0, 0, 0, 1])).toStrictEqual([
