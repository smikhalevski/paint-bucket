...
describe('convertXYZToLABh', () => {
  test('converts black XYZ to LABh', () => {
    expect(convertXYZToLABh([0, 0, 0, 1], [0, 0, 0, 1])).toStrictEqual([0, 0, 0, 1]);
  });

  test('converts white XYZ to LABh', () => {
    expect(convertXYZToLABh([0.95, 1, 1, 1], [0, 0, 0, 1])).toStrictEqual([
      10, -0.5425000000000004, 1.0710000000000002, 1,
    ]);
  });

  test('converts XYZ to LABh', () => {
    expect(convertXYZToLABh([0.25, 0.4, 0.15, 1], [0, 0, 0, 1])).toStrictEqual([
...
describe('convertLABhToXYZ', () => {
  test('converts LABh to XYZ', () => {
    ...
    expect(convertLABhToXYZ(lab, [0, 0, 0, 1])).toStrictEqual([
